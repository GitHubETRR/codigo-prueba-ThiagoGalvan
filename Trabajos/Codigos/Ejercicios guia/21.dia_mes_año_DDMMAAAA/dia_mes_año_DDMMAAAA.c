...
int main(){
    int DDMMAAAA,days,month,year,bisiesto,redo;
    ...
    do{
        ...
        if(month>12){
            printf("Error, el mes debe ser menor o igual a 12\n");
        }
        else if(days>30 && (4==month||6==month||9==month||11==month)){
            ...
            printf("¿Quiere ingresar otra fecha?\n");
            printf("(0)No\n");
            printf("(1)Si\n");
            scanf("%d",&redo);
    }while(redo==1);
