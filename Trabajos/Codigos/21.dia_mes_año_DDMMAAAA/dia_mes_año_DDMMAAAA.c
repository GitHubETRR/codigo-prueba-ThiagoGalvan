...
int main(){
    ...
    printf("En este programa al ingresar una fecha en el formato DDMMAAAA se va a poder separar en Dia, mes y Año\n");
    ...
    else if (2==month && 29<days)
    {
        ...
        {
            printf("El año no es bisiesto por lo que febrero no tiene 29 dias");
        }
